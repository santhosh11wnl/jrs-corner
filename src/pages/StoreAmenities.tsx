  ...
  return (
    <div>
      <Hero
        ...
        backgroundImage="https://images.unsplash.com/photo-1581579186913-45ac24ed53d2?q=80&w=1200&auto=format&fit=crop"
      />
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden mb-16">
            <div className="p-8">
              <div className="flex items-center mb-6">
                <Fuel size={28} className="text-[#9b87f5] mr-3" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                <div className="bg-pitstop-lightblue p-6 rounded-lg">
                  <div className="flex items-center">
                    <Droplet size={24} className="text-[#9b87f5] mr-3" />
                ...
                <div className="bg-pitstop-lightblue p-6 rounded-lg">
                  <div className="flex items-center">
                    <Fuel size={24} className="text-[#9b87f5] mr-3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md text-center">
              <Droplet size={48} className="mx-auto text-[#9b87f5] mb-4" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-md text-center">
              <Fuel size={48} className="mx-auto text-[#9b87f5] mb-4" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-md text-center">
              <Wind size={48} className="mx-auto text-[#9b87f5] mb-4" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-md text-center">
              <Banknote size={48} className="mx-auto text-[#9b87f5] mb-4" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-md text-center">
              <div className="relative h-12 w-12 mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="text-[#9b87f5]" width="48" height="48" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md text-center">
              <Utensils size={48} className="mx-auto text-[#9b87f5] mb-4" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-md text-center col-span-1 md:col-span-2 lg:col-span-3">
              <CreditCard size={48} className="mx-auto text-[#9b87f5] mb-4" />
