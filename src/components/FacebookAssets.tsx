      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mb-6 border-2 border-dashed border-gray-300 p-4 rounded-lg">
            <div 
              id="fb-cover-image" 
              className="bg-pitstop-darkblue relative overflow-hidden" 
              style={{ width: '100%', height: '312px', maxWidth: '820px', margin: '0 auto' }}
            >
          ...
          <button
            ...
            onClick={() => downloadAsImage('fb-cover-image', 'jrs-corner-facebook-cover.png')}
          >
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mb-6 border-2 border-dashed border-gray-300 p-4 rounded-lg flex justify-center">
            <div 
              id="fb-profile-image" 
              className="bg-pitstop-darkblue relative overflow-hidden rounded-full"
          ...
          <button
            className="btn-primary w-full flex items-center justify-center"
            onClick={() => downloadAsImage('fb-profile-image', 'jrs-corner-facebook-profile.png')}
          >
            <Download size={18} className="mr-2" />
